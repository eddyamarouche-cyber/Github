...
export const slides: Slide[] = [
  ...
  },
  {
    ...
    content: {
      ...
      logos: [
        { name: 'BBVA', src: '/images/must-win/bbva.svg' },
        { name: 'Bending Spoons', src: '/images/must-win/bending-spoons.svg' },
        { name: 'Unicredit', src: '/images/must-win/unicredit.svg' },
        { name: 'Santander', src: '/images/must-win/santander.svg' },
        { name: 'Amadeus', src: '/images/must-win/amadeus.png' },
        { name: 'Telefonica', src: '/images/must-win/telefonica.svg' },
        { name: 'Fastweb', src: '/images/must-win/fastweb.svg' },
        { name: 'Vodafone', src: '/images/must-win/vodafone.svg' },
        { name: 'Indra', src: '/images/must-win/indra.svg' },
        { name: 'Engineering', src: '/images/must-win/engineering.png' },
        { name: 'Nexi', src: '/images/must-win/nexi.svg' },
        { name: 'Telecom Italia', src: '/images/must-win/telecom-italia.svg' },
        { name: 'Reply', src: '/images/must-win/reply.svg' },
        { name: 'Inditex', src: '/images/must-win/inditex.svg' },
        { name: 'Odigeo', src: '/images/must-win/odigeo.svg' },
        { name: 'Adevinta', src: '/images/must-win/adevinta.svg' },
      ],
    },
  },
  {
